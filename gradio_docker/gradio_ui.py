...
def get_preds(data):
    ...
    response = requests.post("https://obesity.projects-pea.ru/api/predict_features", json={"data": data}) #api:8000 | "https://obesity.projects-pea.ru/api/predict_features" | "http://api-obesity:3000/predict_features"
